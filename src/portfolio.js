...
const about = {
  ...
  role: 'Artificial Inteligence Master student and Junior Software Engineer',
  description:
...
const projects = [
  ...
  // if there are no projects, Projects section won't show up
  {
    name: '2048 AI Solver',
    description:
      'Implemented the 2048 game using Pygame and developed an AI using the Minimax algorithm. Working on optimizing with heuristics and dynamic tile generation.',
  ...
  },
  {
    ...
    description: 'An introductory application designed to demonstrate CRUD operations by creating an API with a database and using it with React.',
